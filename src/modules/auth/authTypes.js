...
export const REMOVE_CONNECTED_USER_START =
  'auth/REMOVE_CONNECTED_USER_START';
export const REMOVE_CONNECTED_USER_SUCCESS =
  'auth/REMOVE_CONNECTED_USER_SUCCESS';
export const REMOVE_CONNECTED_USER_ERROR =
  'auth/REMOVE_CONNECTED_USER_ERROR';
